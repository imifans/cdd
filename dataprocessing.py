...
IR_files = sorted(get_img_file(r"/home/2021/hexin/XJ2/DataSet/MSRS/train/ir"))
VIS_files   = sorted(get_img_file(r"/home/2021/hexin/XJ2/DataSet/MSRS/train/vi"))

assert len(IR_files) == len(VIS_files)
h5f = h5py.File(os.path.join('/home/2021/hexin/XJ2/Result/CDDFuse/Data',
...
with h5py.File(os.path.join('/home/2021/hexin/XJ2/Result/CDDFuse/Data',
